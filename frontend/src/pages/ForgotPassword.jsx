    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-4">
      ...
      <div className="relative bg-white p-10 rounded-3xl shadow-xl w-full max-w-md border border-gray-200">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Placify</h1>
          ...
          <form onSubmit={handleOtpSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  maxLength="6"
                  className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-gray-400 transition duration-200 tracking-widest text-center text-lg font-semibold"
                  placeholder="000000"
                />
              </div>
            ...
            <div className="flex gap-3">
              <button
                type="button"
                onClick={() => setStep(1)}
                className="flex-1 bg-gray-200 text-gray-700 py-3 px-4 rounded-xl hover:bg-gray-300 font-semibold transition duration-200"
              >
                Back
              </button>
              <button
